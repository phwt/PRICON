...
<head>
    ...
    <style>
        ...
        .first-twin {
            background-image: url("main-grad.svg");
...
<div class="well" id="well">
                ...
                <div class="row" style="padding: 15vh;">
                    ...
                    <div class="col-5 center-me">
                        ...
                        <h1 style="font-weight: 800;line-height: 1.5em;font-size: 35pt">
                            <img id="ip_flag" class="hideme" src="https://ipgeolocation.io/static/flags/th_64.png"/>
                    ...
                    <div class="col-6 center-me text-center">
                        <img src="https://via.placeholder.com/350x500" class="img-fluid" alt="Responsive image">
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="container-fluid center-me">
            <div class="row">
                <div class="col-3" style="padding:0;">
                    <img src="s1.jpg" class="img-fluid" alt="Responsive image">
                </div>

                <div class="col-3 shadow-lg text-center" style="padding:0;">
                    <img src="s2.jpg" class="img-fluid" alt="Responsive image">
                ...
                <div class="col-3" style="padding:0;">
                    <img src="s3.jpg" class="img-fluid" alt="Responsive image">
                </div>

                <div class="col-3" style="padding:0;">
                    <img src="s4.jpg" class="img-fluid" alt="Responsive image">
                </div>
            </div><br><br><br>
        </div>
    </section>
    ...
    <section class="section" width="100%">
        <div class="container-fluid panel text-center">
            ...
            <div class="row table-hover" style="padding: 0 10% 0% 10%">
                    ...
                    <table>
                        <tr>
                            <td class="text-center" style="padding-bottom: 8px;">
                                <img width="100" style="padding:20" src="sico/washing-machine.svg" class="img-fluid" alt="Responsive image">
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="col-4 prod-sel bg-white center-flex bdr bdrb">
                    <table>
                        <tr>
                            <td class="text-center" style="padding-bottom: 8px;">
                                <img width="100" style="padding:20" src="sico/hanger.svg" class="img-fluid" alt="Responsive image">
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="col-4 prod-sel bg-white center-flex bdrb">
                    <table>
                        <tr>
                            <td class="text-center" style="padding-bottom: 8px;">
                                <img width="100" style="padding:20" src="sico/smartphone-call.svg" class="img-fluid" alt="Responsive image">
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center">
                ...
                <div class="col-4 prod-sel bg-white center-flex bdr">
                    <table>
                        <tr>
                            <td class="text-center" style="padding-bottom: 8px;">
                                <img width="100" style="padding:20" src="sico/football.svg" class="img-fluid" alt="Responsive image">
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center">
                ...
                <div class="col-4 prod-sel bg-white center-flex bdr">
                    <table>
                        <tr>
                            <td class="text-center" style="padding-bottom: 8px;">
                                <img width="100" style="padding:20" src="sico/stars.svg" class="img-fluid" alt="Responsive image">
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center">
                ...
                <div class="col-4 prod-sel bg-white center-flex">
                    <table>
                        <tr>
                            <td class="text-center" style="padding-bottom: 8px;">
                                <img width="100" style="padding:20" src="sico/roller.svg" class="img-fluid" alt="Responsive image">
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center">
            ...
            <a onclick="selNone()" class="text-center text-muted"><u>ข้าม</u></a>
        </div>
        <a sname="acc"></a>
    </section>
...
<script type="text/javascript" src="ip_scripts.js"></script>
